...
class ShopSeeder extends Seeder {
    ...
    private function createProductsAndCategories() {
        ...
        $wings = CategoryTest::createWithPath([
            'name'        => 'Wing Series',
        ...
        $transportation = CategoryTest::createWithPath([
            'name'        => 'Transportation',
        ...
        $tools = CategoryTest::createWithPath(['name' => 'Tools']);
        CategoryTest::createWithPath(['name' => 'Manual'], $tools);
        CategoryTest::createWithPath(['name' => 'Power'], $tools);

        CategoryTest::createWithPath(['name' => 'Devices']);
    }
